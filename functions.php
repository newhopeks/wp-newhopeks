...
add_action('init', 'nh_custom_init');
function nh_custom_init() 
{
  $labels = array(
...
add_action('init','create_nh_taxonomies');
function create_nh_taxonomies(){
	$labels = array(
		...
		'separate_items_with_commas' => __( 'Separate series names with commas' ),
